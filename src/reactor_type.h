...
#define MAXFD 10000 //this is the number of pollfd as input to poll()
#define BACKLOG 1000
#define SIP_MSG_MAX_SIZE  64*1024 //maximum size of SIP message we accept
#define SIP_UDP_MSG_MAX_SIZE 3*1024 //maximum size of SIP message through UDP
#define TEMP_MSG_SIZE   1024  //Length of data each time read() from kernel
